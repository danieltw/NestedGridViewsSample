...
namespace Web001
{
    public partial class NestedGridViews_Sample01 : System.Web.UI.Page
    {
        ...
        private static DataTable GetMainData()
        {
            ...
            for (int i = 1; i < 27; i++)
            {
                dt.Rows.Add(new object[] { string.Format("{0}{1}", "Data", i.ToString("00")), (_rnd.Next(1, 10) * _rnd.Next(11, 25)).ToString(), i % 3 == 0 ? "是" : "否", (_rnd.Next(1, 10) * _rnd.Next(40, 60) * _rnd.Next(15, 25)).ToString() });
            }
